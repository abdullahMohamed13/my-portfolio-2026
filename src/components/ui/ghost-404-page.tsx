    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <motion.p 
            className="text-lg md:text-xl text-foreground opacity-50 font-dm-sans select-none"
            variants={itemVariants}
          >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Nice try though, you wanted to see if I care about 404 pages.
					</motion.p>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
          or you are just missing idk maybe I am tweaking 🫩..
          </motion.p>
          ...
          >
            <Link 
              to="/"
              className="inline-block bg-primary text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-destructive transition-colors font-dm-sans select-none"
            >
            	GO HOME
            </Link>
          </motion.div>
